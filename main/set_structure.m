...
function structure = set_structure(boats,varargin)
 ...
 % FishMIP classes
 structure.fishmip_2d = permute(repmat(structure.fmass,[length(ECOL.minfishmip) 1]), [2 1])./repmat(ECOL.minfishmip,[ECOL.nfmass 1]);
 structure.fishmip_2d(structure.fishmip_2d < 1) = 0;
 structure.fishmip_2d(structure.fishmip_2d >= 1) = 1;
 structure.fishmip_4d = permute(repmat(structure.fishmip_2d,[1 1 FORC.nlat FORC.nlon]),[3 4 1 2]);
 %---------------------------------
 % Masks
 ...
 mask_land_g_1fishmip    = double(repmat(mask_land_2d,[1 1 ECOL.nfishmip]));        % land mask groups 1 timestep
 ...
 structure.mask_land_g_nan_fishmip  = mask_land_g_1fishmip;
 %-----------------------------------------------------------------------------------------
